...
export function resolveAppApiSurface(apiNamespace: Record<string, any> = api): AppApiSurface {
  return {
    ...
    pruneChatBranch: resolveOptionalApi(apiNamespace, 'deleteChatBranch', null),
    purgeChatBranch: resolveOptionalApi(apiNamespace, 'deleteChatBranch', null),
    restoreChatBranch: null,
